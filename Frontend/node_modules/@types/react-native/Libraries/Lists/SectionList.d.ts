import type { ListRenderItemInfo, VirtualizedListWithoutRenderItemProps } from "@react-native/virtualized-lists";
    ...
    extends React.ComponentClass<SectionListProps<ItemT, SectionT>>
{
     ...
     * Scrolls to the item at the specified sectionIndex and itemIndex (within the section)
     * positioned in the viewable area such that viewPosition 0 places it at the top
     * (and may be covered by a sticky header), 1 at the bottom, and 0.5 centered in the 